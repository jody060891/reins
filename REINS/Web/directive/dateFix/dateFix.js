angular.module('PKBL').directive('dateFix', ['dateFilter', 'datepickerPopupConfig', function(dateFilter, datepickerPopupConfig) {
    ...
    return {
        ...
        link: function(scope, element, attrs, ngModel) {
            ...
            element.on('blur', {scope:scope}, function(e) {
                ...
                var newDate = model.$viewValue;
                if (typeof newDate === "object" || newDate == "") return;
                if (format === "dd-MM-yyyy") {
                    // extract day, month and year
                    var splitted = newDate.split('-');
