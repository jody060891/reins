...
{
    public class FixedDictionaryValueProvider<TValue> : IValueProvider, IEnumerableValueProvider
    {
        ...
        public FixedDictionaryValueProvider(IDictionary<string, TValue> dictionary, CultureInfo culture)
        {
            ...
            _prefixContainer = new Lazy<FixedPrefixContainer>(() => new FixedPrefixContainer(_values.Keys), true);
        }
